...
5. Show the exact rendered project log draft and ask whether the user wants edits or approval. Treat pending-update/status metadata as separate review metadata, not as part of the approvable draft.
